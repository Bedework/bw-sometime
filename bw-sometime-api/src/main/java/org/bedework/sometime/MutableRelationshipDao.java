...
public interface MutableRelationshipDao extends RelationshipDao {
	 ...
	 */
	Relationship createRelationship(ScheduleOwner owner, IScheduleVisitor visitor, String relationshipDescription);
	 ...
	 * @param visitor
	 */
	void destroyRelationship(ScheduleOwner owner, IScheduleVisitor visitor);
}
