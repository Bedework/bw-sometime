...
import org.bedework.sometime.impl.events.AvailableScheduleChangedEvent;
...
implements AvailableScheduleDao {
	...
	/*
	 * (non-Javadoc)
	 * @see org.jasig.schedassist.impl.owner.AvailableScheduleDao#addToSchedule(org.jasig.schedassist.model.ScheduleOwner, org.jasig.schedassist.model.AvailableBlock)
	 */
	@Transactional
	@Override
	public AvailableSchedule addToSchedule(final ScheduleOwner owner, final AvailableBlock block) {
	...
	/*
	 * (non-Javadoc)
	 * @see org.jasig.schedassist.impl.owner.AvailableScheduleDao#addToSchedule(org.jasig.schedassist.model.ScheduleOwner, java.util.Set)
	 */
	@Transactional
	@Override
	public AvailableSchedule addToSchedule(final ScheduleOwner owner,
	...
	/*
	 * (non-Javadoc)
	 * @see org.jasig.schedassist.impl.owner.AvailableScheduleDao#clearAllBlocks(org.jasig.schedassist.model.ScheduleOwner)
	 */
	@Transactional
	@Override
	public void clearAllBlocks(final ScheduleOwner owner) {
	...
	/*
	 * (non-Javadoc)
	 * @see org.jasig.schedassist.impl.owner.AvailableScheduleDao#removeFromSchedule(org.jasig.schedassist.model.ScheduleOwner, org.jasig.schedassist.model.AvailableBlock)
	 */
	@Transactional
	@Override
	public AvailableSchedule removeFromSchedule(final ScheduleOwner owner,
	...
	/*
	 * (non-Javadoc)
	 * @see org.jasig.schedassist.impl.owner.AvailableScheduleDao#removeFromSchedule(org.jasig.schedassist.model.ScheduleOwner, java.util.Set)
	 */
	@Transactional
	@Override
	public AvailableSchedule removeFromSchedule(final ScheduleOwner owner,
	...
	/*
	 * (non-Javadoc)
	 * @see org.jasig.schedassist.impl.owner.AvailableScheduleDao#retrieve(org.jasig.schedassist.model.ScheduleOwner)
	 */
	@Override
	public AvailableSchedule retrieve(final ScheduleOwner owner) {
	...
	/*
	 * (non-Javadoc)
	 * @see org.jasig.schedassist.impl.owner.AvailableScheduleDao#retrieve(org.jasig.schedassist.model.ScheduleOwner, java.util.Date, java.util.Date)
	 */
	@Override
	public AvailableSchedule retrieve(ScheduleOwner owner, Date startTime,
			Date endTime) {
	...
	/*
	 * (non-Javadoc)
	 * @see org.jasig.schedassist.impl.owner.AvailableScheduleDao#retrieveWeeklySchedule(org.jasig.schedassist.model.ScheduleOwner, java.util.Date)
	 */
	@Override
	public AvailableSchedule retrieveWeeklySchedule(final ScheduleOwner owner, final Date weekOf) {
	...
	/*
	 * (non-Javadoc)
	 * @see org.jasig.schedassist.impl.owner.AvailableScheduleDao#retrieveTargetBlock(org.jasig.schedassist.model.ScheduleOwner, java.util.Date)
	 */
	@Override
	public AvailableBlock retrieveTargetBlock(final ScheduleOwner owner,
	...
	/* (non-Javadoc)
	 * @see org.jasig.schedassist.impl.owner.AvailableScheduleDao#retrieveTargetBlock(org.jasig.schedassist.model.ScheduleOwner, java.util.Date, java.util.Date)
	 */
	@Override
	public AvailableBlock retrieveTargetBlock(ScheduleOwner owner,
	...
	/*
	 * (non-Javadoc)
	 * @see org.jasig.schedassist.impl.owner.AvailableScheduleDao#retrieveTargetDoubleLengthBlock(org.jasig.schedassist.model.ScheduleOwner, java.util.Date)
	 */
	@Override
	public AvailableBlock retrieveTargetDoubleLengthBlock(ScheduleOwner owner,
			Date startDate) {		
		SortedSet<AvailableBlock> expanded = retrieveBlocksForDayInternal(owner, startDate);
		// truncate startDate to the second
		final Date truncatedStart = DateUtils.truncate(startDate, Calendar.MINUTE);
	 ...
	 */
	protected SortedSet<AvailableBlock> retrieveBlocksForDayInternal(ScheduleOwner owner, Date referenceDay) {
	...
	public int purgeExpiredBlocks(final Integer daysPrior) {
        final String propertyValue =
								System.getProperty(
												"org.jasig.schedassist.runScheduledTasks",
												"true");

        if (Boolean.parseBoolean(propertyValue)) {
					final Date priorTo = DateUtils.truncate(
        	...
        	final int rowCount =
									simpleJdbcTemplate.update(
													"delete from schedules where end_time < :end",
													params);
        	LOG.warn("purged " + rowCount +
													 " rows from schedules table with end_time values prior to: " + priorTo);
        	return rowCount;
        } else {
        	LOG.debug("ignoring purgeExpiredBlocks as " +
	 ...
	 * @return 
	 */
	protected SortedSet<AvailableBlock> internalRetrieveSchedule(final ScheduleOwner owner) {
		MapSqlParameterSource params = new MapSqlParameterSource();
	 ...
	 * @return
	 */
	protected SortedSet<AvailableBlock> internalRetrieveSchedule(final ScheduleOwner owner, final Date startDate, final Date endDate) {		
	 ...
	 * @param blocks
	 */
	private void replaceSchedule(final ScheduleOwner owner, final SortedSet<AvailableBlock> blocks) {
