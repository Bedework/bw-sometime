...
import org.bedework.sometime.impl.reminder.DefaultReminderServiceImpl;
import org.bedework.sometime.impl.reminder.EmailAddressValidator;
import org.bedework.sometime.impl.reminder.IReminder;
import org.bedework.sometime.impl.reminder.PersistedReminderImpl;
import org.bedework.sometime.impl.reminder.ReminderDao;
import org.bedework.sometime.impl.reminder.ReminderImpl;
...
public class DefaultReminderServiceImplTest {
	...
	public void testPersistedReminderWithInvalidEmailAddress() throws InputFormatException {
		...
		verify(reminderDao, times(1)).deleteEventReminder(isA(
            ReminderImpl.class));
	}
