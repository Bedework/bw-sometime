 ...
 * an {@link ScheduleOwner}'s visible schedule.
 * 
...
public class VisibleScheduleRequestConstraints implements Serializable {
	 ...
	 * 
	 * @param owner the target {@link ScheduleOwner} for the request
	 ...
	 */
	public static VisibleScheduleRequestConstraints newInstance(ScheduleOwner owner, int weekStart) {
