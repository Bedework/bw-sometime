...
import org.bedework.sometime.model.PublicProfile;
import org.bedework.sometime.model.PublicProfileId;
import org.bedework.sometime.model.PublicProfileTag;
...
public class SpringJDBCPublicProfileDaoImpl 
	...
	/*
	 * (non-Javadoc)
	 * @see org.jasig.schedassist.impl.owner.PublicProfileDao#createPublicProfile(org.jasig.schedassist.model.ScheduleOwner, java.lang.String)
	 */
	@Transactional
	@Override
	@TriggersRemove(cacheName="publicProfileCache", removeAll=true)
	public PublicProfile createPublicProfile(ScheduleOwner owner,
	...
	/*
	 * (non-Javadoc)
	 * @see org.jasig.schedassist.impl.owner.PublicProfileDao#locatePublicProfileByOwner(org.jasig.schedassist.model.ScheduleOwner)
	 */
	@Override
	public PublicProfile locatePublicProfileByOwner(final ScheduleOwner owner) {
		List<PublicProfile> profiles = this.simpleJdbcTemplate.query(
