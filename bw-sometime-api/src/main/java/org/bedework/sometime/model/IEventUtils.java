...
public interface IEventUtils {
	 ...
	 */
	VEvent constructAvailableAppointment(AvailableBlock block, ScheduleOwner owner, IScheduleVisitor visitor, 
	 ...
	 */
	boolean isAttendingMatch(VEvent event, IScheduleVisitor visitor, ScheduleOwner owner);
	 ...
	 * @param event
	 * @param proposedOwner
	 * @return true if proposedOwner is in the {@link VEvent}'s attendee list as an {@link ScheduleOwner}
	 */
