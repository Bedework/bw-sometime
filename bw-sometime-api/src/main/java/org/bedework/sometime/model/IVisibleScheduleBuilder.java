...
public interface IVisibleScheduleBuilder {
	...
	/**
	 * This method should simply delegate to {@link #calculateVisibleSchedule(Date, Date, Calendar, AvailableSchedule, ScheduleOwner, IScheduleVisitor)},
	 ...
	 */
	VisibleSchedule calculateVisibleSchedule(
					Date startTime,
					Date endTime,
					Calendar calendar,
	 ...
	 * an {@link ScheduleOwner}'s account.
	 * 
	 * @param startTime
	 * @param endTime
	 * @param calendar
	 ...
	 * within the display of an {@link ScheduleOwner}s schedule.
	 * 
	 * The {@link MeetingDurations} argument is required and represents the preference of the {@link ScheduleOwner} in
	 * context.
	 * 
	 * @param startTime
	 * @param endTime
	 ...
	 * @return an appropriate {@link VisibleSchedule}
	 */
	VisibleSchedule calculateVisitorConflicts(
					Date startTime,
					Date endTime,
					Calendar calendar,
					AvailableSchedule schedule,
