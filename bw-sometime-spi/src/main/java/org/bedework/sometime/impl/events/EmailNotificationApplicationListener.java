...
public class EmailNotificationApplicationListener implements
	 ...
	 * @param event
	 */
	protected void sendEmail(final ScheduleOwner owner, final IScheduleVisitor visitor, final VEvent event, final String messageBody) {
		if (null != mailSender) {
	...
	/**
	 * This method implements the logic to determine whether or not the {@link ScheduleOwner}'s email address is valid
	 ...
	 */
	protected String createMessageBody(final VEvent event, String eventDescription, ScheduleOwner owner) {
	 ...
	 * @return the body of the message as a {@link String}
	 */
	protected String cancelMessageBody(final VEvent event, final String cancelReason, final ScheduleOwner owner) {
		StringBuilder messageBody = new StringBuilder();
