...
public interface PublicProfileDao {
	 ...
	 */
	PublicProfile createPublicProfile(ScheduleOwner owner, String profileDescription) throws PublicProfileAlreadyExistsException;
	 ...
	 * @return the correspoding public profile, or null if not found
	 */
	PublicProfile locatePublicProfileByOwner(ScheduleOwner owner);
