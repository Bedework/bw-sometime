...
public interface ICalendarDataDao {
	 ...
	 * in the {@link ScheduleOwner}'s schedule.
	 * 
	 ...
	 */
	VEvent getExistingAppointment(ScheduleOwner owner, AvailableBlock block);
	
	/**
	 * Create an appointment.
	 * The {@link ScheduleOwner} must be the "owner" of the appointment.
	 ...
	 */
	VEvent createAppointment(IScheduleVisitor visitor, ScheduleOwner owner, AvailableBlock block, String eventDescription);
	/**
	 * Cancel the specified appointment in the {@link ScheduleOwner}'s schedule.
	 * 
	 * @param visitor
	 * @param owner
	 * @param event
	 */
	void cancelAppointment(IScheduleVisitor visitor, ScheduleOwner owner, VEvent event);
	
	
	/**
	 * Add the specified {@link IScheduleVisitor} as an attendee to the {@link VEvent} in
	 * the {@link ScheduleOwner}'s schedule.
	 * 
	 * @param visitor
	 * @param owner
	 * @param appointment
	 ...
	 */
	VEvent joinAppointment(IScheduleVisitor visitor, ScheduleOwner owner, VEvent appointment) throws SchedulingException;
	 ...
	 * @throws SchedulingException
	 */
	VEvent leaveAppointment(IScheduleVisitor visitor, ScheduleOwner owner, VEvent appointment) throws SchedulingException;
	
	/**
	 * Check the {@link ScheduleOwner}'s schedule for events within the times
	 ...
	 */
	void checkForConflicts(ScheduleOwner owner, AvailableBlock block) throws ConflictExistsException;
	
	/**
	 * The purpose of this method is to reflect a copy of the {@link ScheduleOwner}'s 
	 ...
	 * @param schedule
	 */
	void reflectAvailableSchedule(ScheduleOwner owner, AvailableSchedule schedule);
	
	/**
	 * Purge any available schedule reflections from the specified {@link ScheduleOwner}'s
	 ...
	 * @param endDate
	 */
	void purgeAvailableScheduleReflections(ScheduleOwner owner, Date startDate, Date endDate);
}
