...
import org.bedework.sometime.model.Reminders;
...
public class DefaultReminderServiceImpl implements ReminderService, Runnable {
	...
	/*
	 * (non-Javadoc)
	 * @see org.jasig.schedassist.impl.reminder.ReminderService#createEventReminder(org.jasig.schedassist.model.ScheduleOwner, org.jasig.schedassist.model.ICalendarAccount, org.jasig.schedassist.model.AvailableBlock, net.fortuna.ical4j.model.component.VEvent, java.util.Date)
	 */
	@Override
	public IReminder createEventReminder(ScheduleOwner owner,
	...
	/*
	 * (non-Javadoc)
	 * @see org.jasig.schedassist.impl.reminder.ReminderService#getReminder(org.jasig.schedassist.model.ScheduleOwner, org.jasig.schedassist.model.ICalendarAccount, org.jasig.schedassist.model.AvailableBlock)
	 */
	@Override
	public IReminder getReminder(ScheduleOwner owner,
	...
	/* (non-Javadoc)
	 * @see org.jasig.schedassist.impl.reminder.ReminderService#getReminders(org.jasig.schedassist.model.ScheduleOwner, org.jasig.schedassist.model.AvailableBlock)
	 */
	@Override
	public List<IReminder> getReminders(ScheduleOwner owner,
	...
	protected ReminderImpl complete(PersistedReminderImpl p) {
		...
		final ScheduleOwner scheduleOwner = this.ownerDao.locateOwnerByAvailableId(p.getOwnerId());
	 ...
	 * to {@link SchedulingAssistantService#getExistingAppointment(AvailableBlock, ScheduleOwner)} and
	 ...
	 * 
	 * This is really useful in {@link #getReminders(ScheduleOwner, AvailableBlock)} where all of the
	 ...
	 * @return a complete {@link ReminderImpl}
	 */
	protected ReminderImpl complete(PersistedReminderImpl p, ScheduleOwner owner, VEvent event) {
		if (p == null) {
			return null;
		}
		final ICalendarAccount recipient = this.calendarAccountDao.getCalendarAccount(p.getRecipientId());
	...
	protected void sendEmail(IReminder reminder) {
		if (shouldSend(reminder)) {
			final ScheduleOwner owner = reminder.getScheduleOwner();
	 ...
	 * @return
	 */
	protected String createMessageBody(final VEvent event, ScheduleOwner owner) {
