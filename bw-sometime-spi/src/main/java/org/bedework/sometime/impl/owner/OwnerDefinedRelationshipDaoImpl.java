...
import org.bedework.sometime.MutableRelationshipDao;
...
/**
 * {@link MutableRelationshipDao} implementation that is backed by the {@link ScheduleOwner}
...
public class OwnerDefinedRelationshipDaoImpl implements MutableRelationshipDao {
	 ...
	 */
	@Override
	public List<Relationship> forOwner(final ScheduleOwner owner) {
	...
	public List<Relationship> forVisitor(final IScheduleVisitor visitor) {
		...
		for(OwnerDefinedRelationship stored : relationships) {
			...
			ScheduleOwner owner = ownerDao.locateOwner(calendarUser);
			if (null != owner) {
				Relationship relationship = new Relationship();
				relationship.setOwner(owner);
				relationship.setVisitor(visitor);
	...
	/*
	 * (non-Javadoc)
	 * @see org.jasig.schedassist.MutableRelationshipDao#createRelationship(org.jasig.schedassist.model.ScheduleOwner, org.jasig.schedassist.model.IScheduleVisitor, java.lang.String)
	 */
	@Override
	public Relationship createRelationship(ScheduleOwner owner, IScheduleVisitor visitor,
			String relationship) {
		final String ownerIdentifier = getIdentifyingAttribute(owner.getCalendarAccount());
		final String visitorIdentifier = getIdentifyingAttribute(visitor.getCalendarAccount());
	...
	/*
	 * (non-Javadoc)
	 * @see org.jasig.schedassist.MutableRelationshipDao#destroyRelationship(org.jasig.schedassist.model.ScheduleOwner, org.jasig.schedassist.model.IScheduleVisitor)
	 */
	@Override
	public void destroyRelationship(ScheduleOwner owner, IScheduleVisitor visitor) {
		final String ownerIdentifier = getIdentifyingAttribute(owner.getCalendarAccount());
		final String visitorIdentifier = getIdentifyingAttribute(visitor.getCalendarAccount());
