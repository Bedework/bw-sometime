...
public interface ReminderService {
	 ...
	 * @return
	 */
	IReminder createEventReminder(ScheduleOwner owner, ICalendarAccount recipient, AvailableBlock appointmentBlock, VEvent event, Date reminderSendTime);
	...
	/**
	 * Retrieve the list of existing {@link IReminder}s for the {@link ScheduleOwner} and {@link AvailableBlock}.
	 ...
	 */
	List<IReminder> getReminders(ScheduleOwner owner, AvailableBlock appointmentBlock);
	 ...
	 */
	IReminder getReminder(ScheduleOwner owner, ICalendarAccount recipient, AvailableBlock appointmentBlock);
	 ...
	 * @param owner
	 */
	//void deletePendingReminders(ScheduleOwner owner);
}
