...
import org.bedework.sometime.XMLDataUtils;
import org.bedework.sometime.messaging.AvailableBlockElement;
import org.bedework.sometime.messaging.AvailableStatusType;
import org.bedework.sometime.messaging.CancelAppointmentRequest;
import org.bedework.sometime.messaging.CancelAppointmentResponse;
import org.bedework.sometime.messaging.CreateAppointmentRequest;
import org.bedework.sometime.messaging.CreateAppointmentResponse;
import org.bedework.sometime.messaging.GetRelationshipsRequest;
import org.bedework.sometime.messaging.GetRelationshipsResponse;
import org.bedework.sometime.messaging.GetScheduleOwnerByIdRequest;
import org.bedework.sometime.messaging.GetScheduleOwnerByIdResponse;
import org.bedework.sometime.messaging.GetTargetAvailableBlockRequest;
import org.bedework.sometime.messaging.GetTargetAvailableBlockResponse;
import org.bedework.sometime.messaging.ObjectFactory;
import org.bedework.sometime.messaging.PreferencesElement;
import org.bedework.sometime.messaging.PreferencesSet;
import org.bedework.sometime.messaging.RelationshipElement;
import org.bedework.sometime.messaging.ScheduleOwnerElement;
import org.bedework.sometime.messaging.VisibleScheduleRequest;
...
public class ObjectMarshallingTest {
	...
	public void testCancelAppointmentRequest() throws Exception {
		...
		request.setEndTime(
						XMLDataUtils.convertDateToXMLGregorianCalendar(toDateTime("20091117-1300")));
		request.setOwnerId(42L);
		request.setReason("Some reason to cancel");
		request.setStartTime(
						XMLDataUtils.convertDateToXMLGregorianCalendar(toDateTime("20091117-1230")));
	...
	public void testVisibleScheduleRequestFromSample() throws Exception {
		...
		Assert.assertEquals(1L, (long)request.getWeekStart());
	}
	...
	public void testVisibleScheduleRequestWithWeekStart() throws Exception {
		...
		Assert.assertEquals(135L, request.getOwnerId());
		Assert.assertEquals("visitorid", request.getVisitorNetid());
		Assert.assertEquals(6, (long)request.getWeekStart());
	}
	...
	public void testGetTargetAvailableBlockRequest() throws Exception {
		...
		Date now = new Date();
		request.setStartTime(
						XMLDataUtils.convertDateToXMLGregorianCalendar(now));
	...
	public void testGetTargetAvailableBlockResponse() throws Exception {
		...
		element.setStartTime(
						XMLDataUtils.convertDateToXMLGregorianCalendar(start));
		element.setEndTime(
						XMLDataUtils.convertDateToXMLGregorianCalendar(end));
		...
		Assert.assertNotNull(result);
		Assert.assertEquals(0, (long)result.getAvailableBlockElement().getVisitorsAttending());
		Assert.assertEquals(1, (long)result.getAvailableBlockElement().getVisitorLimit());
