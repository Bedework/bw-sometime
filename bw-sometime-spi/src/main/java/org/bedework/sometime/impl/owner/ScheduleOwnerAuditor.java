...
/**
 * Tool for auditing {@link ScheduleOwner} records.
 *  
...
public final class ScheduleOwnerAuditor extends JdbcDaoSupport {
	...
	protected void auditRecord(final PersistenceScheduleOwner owner) {
		...
		if (this.purge) {
			...
			ScheduleOwner ownerAccount = ownerDao.locateOwner(ineligible);
	...
	/**
	 * Construct a {@link ICalendarAccount} sufficient to locate a {@link ScheduleOwner} for removal
	 * 
