...
/**
 * {@link Validator} for {@link RemoveAccountFormController}.
 *  
 * @author Nicholas Blair, nblair@doit.wisc.edu
 * @version $Id: RemoveAccountFormBackingObjectValidator.java 2303 2010-07-28 17:17:44Z npblair $
 */
public class RemoveAccountFormBackingObjectValidator implements Validator {
	...
	public boolean supports(Class<?> clazz) {
		return RemoveAccountFormBackingObject.class.equals(clazz);
	}
