...
import org.bedework.sometime.impl.owner.IneligibleException;
import org.bedework.sometime.impl.owner.OwnerDao;
import org.bedework.sometime.impl.owner.SpringJDBCOwnerDaoImpl;
 ...
 */
public class OwnerDaoImplTest extends NeedsTestDatabase {
	...
	public void testRegister() throws Exception {
		...
		ScheduleOwner owner1 = ownerDao.register(user1);
		...
		ScheduleOwner owner2 = ownerDao.register(user2);
	...
	public void testRegisterTwice() throws Exception {
		...
		ScheduleOwner attempt2 = ownerDao.register(user1);
	...
	public void testExternalUniqueIdChanges() throws IneligibleException {
		...
		ScheduleOwner owner = ownerDao.register(user);
		Assert.assertNotNull(owner);
		Assert.assertEquals(1, owner.getId());
		Map<Preferences, String> ownerPrefs = owner.getPreferences();
		Assert.assertEquals(Preferences.getDefaultPreferences(), ownerPrefs);
		
		ScheduleOwner updated = ownerDao.updatePreference(owner, Preferences.LOCATION, "My new office!");
		...
		ScheduleOwner target = this.ownerDao.locateOwner(updatedUser);
	...
	public void testLookupByIdUsernameChanged() throws Exception {
		...
		ScheduleOwner target = this.ownerDao.locateOwnerByAvailableId(1L);
		Assert.assertNotNull(target);
		Assert.assertEquals(updated.getId(), target.getId());
		Assert.assertEquals(updated.getPreferredLocation(), target.getPreferredLocation());
