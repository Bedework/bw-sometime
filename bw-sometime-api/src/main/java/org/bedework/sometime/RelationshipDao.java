 ...
 * for {@link ScheduleOwner}s and {@link IScheduleVisitor}s.
 *  
...
public interface RelationshipDao {
	 ...
	 * the specified {@link ScheduleOwner}.
	 * 
	 * Do not return null; if there are no results for specified owner 
	 * return an empty {@link List}.
	 *  
	 * @param owner
	 * @return a never null, but possibly empty, {@link List} of {@link Relationship}s including the {@link ScheduleOwner}.
	 */
	List<Relationship> forOwner(ScheduleOwner owner);
